...
internal sealed class FakeChatClient : IChatClient
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        var text = options?.ResponseFormat is ChatResponseFormatJson
            ? """
                {
                  "recipe": {
                    "title": "Spaghetti al Pomodoro",
                    "cuisine": "Italian",
                    "ingredients": ["400g spaghetti", "800g tomatoes", "olive oil", "garlic", "basil", "salt"],
